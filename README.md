...
| [Create Pull Request](./actions/common/create-pull-request) | Creates or updates a pull request using GitHub App authentication with optional branch reset. | [actions-common-create-pull-request-v1.0.9](https://github.com/TimSchoenle/actions/releases/tag/actions-common-create-pull-request-v1.0.9) | `uses: TimSchoenle/actions/actions/common/create-pull-request@actions-common-create-pull-request-v1.0.9 # tag=actions-common-create-pull-request-v1.0.9` |
