...
| Action | Description | Version | Usage |
| --- | --- | --- | --- |
| [Rust Auto-format](./actions/rust/auto-format) | Action that runs cargo fmt and commits changes. | [actions-rust-auto-format-v1.1.8](https://github.com/TimSchoenle/actions/releases/tag/actions-rust-auto-format-v1.1.8) | `uses: TimSchoenle/actions/actions/rust/auto-format@actions-rust-auto-format-v1.1.8 # tag=actions-rust-auto-format-v1.1.8` |
