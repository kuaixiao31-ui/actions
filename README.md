...
| [Render Template And Commit](./actions/common/render-template-and-commit) | Renders a Handlebars template to a file and commits the result as a verified bot commit, skipping the commit when the render changed nothing. | [actions-common-render-template-and-commit-v1.1.1](https://github.com/TimSchoenle/actions/releases/tag/actions-common-render-template-and-commit-v1.1.1) | `uses: TimSchoenle/actions/actions/common/render-template-and-commit@actions-common-render-template-and-commit-v1.1.1 # tag=actions-common-render-template-and-commit-v1.1.1` |
